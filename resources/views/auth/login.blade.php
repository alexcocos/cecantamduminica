...
@section('title', 'Autentificare | Ce cântăm duminică')
    ...
    <section class="auth-page">
        <div class="auth-card">
            <div class="auth-introduction">
                ...
                <h1>Setlisturile tale, într-un singur loc</h1>

                <p>
                    Autentifică-te pentru a crea setlisturi,
                    a organiza piesele și a genera materialele
                    de care ai nevoie.
                </p>
                ...
                <div class="auth-benefits">
                    <div>
                        <span>✓</span>
                        <p>Creează și salvează setlisturi</p>
                    </div>

                    <div>
                        <span>✓</span>
                        <p>Schimbă ordinea pieselor în timp real</p>
                    </div>

                    <div>
                        <span>✓</span>
                        <p>Generează PDF și PowerPoint</p>
                    </div>
                </div>
            </div>
